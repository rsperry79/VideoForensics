...
`--auth` is the normal way to get this tool (and the RingApi integration tests) working: it prompts
...
further prompts. See `external/RingApi/README.md` ("Authenticating for local tooling") for the full
