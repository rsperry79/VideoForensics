...
namespace KoenZomers.Ring.ApiTester
{
    ...
    internal sealed class Runner
    {
        ...
        public async Task<IndexDocument> RunAsync(RunOptions options, string credentialSource)
        {
            ...
            Api.Entities.Devices? devices = null;
            List<Api.Entities.Location>? locations = null;
            ...
            if (needsDevices)
            {
                ...
                devices = result as Api.Entities.Devices;
            ...
            if (needsLocations)
            {
                ...
                var (record, result) = await ExecuteAsync(descriptor, EndpointTarget.None, null);
                index.Calls.Add(record);
                locations = result as List<Api.Entities.Location>;
            }
        ...
        {
            var raw = new List<Api.RawApiCall>();
            void Handler(Api.RawApiCall call) => raw.Add(call);

            Api.ApiRawLogger.OnRawResponse += Handler;
