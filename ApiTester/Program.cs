...
namespace KoenZomers.Ring.ApiTester
{
    internal static class Program
    {
        ...
        private const string ReadmePointer = "See external/RingApi/README.md (\"Authenticating for local tooling\") for details.";
        ...
        {
            Console.WriteLine("Ring interactive login - saves a reusable refresh token so future runs (and the RingApi");
            ...
            Console.WriteLine("Future ApiTester runs and the RingApi integration tests will use this automatically.");
            return 0;
        }
