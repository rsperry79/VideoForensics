...
{
    /// <summary>
    /// Progress notification emitted during <see cref="Session.AuthenticateWithCredentials"/>, so a
    /// caller can surface it to the user (e.g. spinner text) without knowing the internal retry logic.
    /// </summary>
