...
{
    public class IntegrityRepositoryTests : IAsyncLifetime
    {
        ...
        public async ValueTask InitializeAsync()
        {
            ...
            _repository = new IntegrityRepository(_fixture.Factory, loggerFactory.CreateLogger<IntegrityRepository>());
        }
