namespace VideoForensics.Forensics.Tests
{
    public class ChainOfCustodyLoggerTests
    {
        ...
        public async Task LogEvidenceReceptionAsync_WithValidData_Succeeds()
        {
            ...
            string handler = "officer-001";

            // Act
            await _logger.LogEvidenceReceptionAsync(evidenceId, handler);

            // Assert
            IEnumerable<ChainOfCustodyEntry> custody = await _logger.GetChainOfCustodyAsync(evidenceId);
        ...
        {
            // Arrange
            string evidenceId = "evidence-456";
            string handler1 = "officer-001";
            string handler2 = "officer-002";
        ...
        public async Task LogCustodyTransferAsync_BetweenHandlers_CreatesTransferEntry()
        {
            // Arrange
            string evidenceId = "evidence-456";
            string fromHandler = "officer-001";
            string toHandler = "lab-tech-002";
        ...
        {
            // Arrange
            string evidenceId = "evidence-transfer-chain";
            string officer = "officer-001";
            string labTech = "lab-tech-002";
            string prosecutor = "prosecutor-003";
        ...
        {
            // Arrange
            string evidenceId = "evidence-789";
            string action = "analyzed";
            string handler = "lab-tech-002";
        ...
        {
            // Arrange
            string evidenceId = "evidence-access-multi";
        ...
        {
            // Arrange
            string evidenceId = "non-existent-evidence";
        ...
        {
            // Arrange
            string evidenceId = "evidence-chrono";
            string handler1 = "officer-001";
            string handler2 = "lab-tech-002";
            string handler3 = "prosecutor-003";
        ...
        {
            // Arrange
            string evidenceId = "non-existent";

            // Act
            bool isValid = await _logger.VerifyCustodyIntegrityAsync(evidenceId);
        ...
        {
            // Arrange
            string evidenceId = "evidence-unbroken";
        ...
        {
            // Arrange
            string evidenceId = "evidence-multi-transfer";
            await _logger.LogEvidenceReceptionAsync(evidenceId, "officer-001");
            await Task.Delay(10);
            await _logger.LogCustodyTransferAsync(evidenceId, "officer-001", "lab-tech-002");
            await Task.Delay(10);
        ...
        {
            // Arrange
            string evidenceId = "evidence-report";
            await _logger.LogEvidenceReceptionAsync(evidenceId, "officer-001");
            await _logger.LogCustodyTransferAsync(evidenceId, "officer-001", "lab-tech-002");

            // Act
            ChainOfCustodyReport report = await _logger.GetCustodyReportAsync(evidenceId);
        ...
        {
            // Arrange
            string evidenceId = "evidence-handlers";
            await _logger.LogEvidenceReceptionAsync(evidenceId, "officer-001");
            await _logger.LogCustodyTransferAsync(evidenceId, "officer-001", "lab-tech-002");
        ...
        {
            // Arrange
            string evidenceId = "evidence-timestamps";
            DateTime beforeLogging = DateTime.UtcNow;
            await _logger.LogEvidenceReceptionAsync(evidenceId, "officer-001");
            await Task.Delay(10);
            await _logger.LogEvidenceAccessAsync(evidenceId, "analyzed", "lab-tech-002");
            DateTime afterLogging = DateTime.UtcNow;

            // Act
            ChainOfCustodyReport report = await _logger.GetCustodyReportAsync(evidenceId);

            // Assert
            _ = Assert.NotNull(report.EvidenceInitiallyReceived);
            _ = Assert.NotNull(report.EvidenceLastAccessed);
        ...
        {
            // Arrange
            string evidenceId = "evidence-integrity";
            await _logger.LogEvidenceReceptionAsync(evidenceId, "officer-001");
            await _logger.LogCustodyTransferAsync(evidenceId, "officer-001", "lab-tech-002");
        ...
        {
            // Arrange
            string evidenceId = "evidence-full-scenario";
        ...
        {
            // Arrange
            string evidence1 = "evidence-001";
            string evidence2 = "evidence-002";
            ...
            // Assert
            IEnumerable<ChainOfCustodyEntry> custody1 = await _logger.GetChainOfCustodyAsync(evidence1);
            IEnumerable<ChainOfCustodyEntry> custody2 = await _logger.GetChainOfCustodyAsync(evidence2);
