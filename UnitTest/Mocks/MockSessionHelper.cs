...
namespace KoenZomers.Ring.UnitTest.Mocks
{
    ...
    public class MockSessionHelper
    {
        ...
        /// </summary>
        public Api.Session CreateSessionWithMockHandler(string username = "test@example.com", string password = "testpass")
        {
            return new Api.Session(username, password, _mockHandler);
        }
